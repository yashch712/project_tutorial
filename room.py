...
class room_booking:
    def __init__(self,root):
        ...
        txtIdNumber=ttk.Entry(lableframeleft,textvariable=self.var_total,font=("arial",13,"bold"),width=29)
        txtIdNumber.grid(row=9,column=1)
        
        # Bill btn:
        btnBill=Button(lableframeleft,text="Bill",font=("arial",11,"bold"),bg="black",fg="gold",width=10)
